...
import 'infrastructure/movies/movie_repository.dart';
...
GetIt $initGetIt(
  ...
  gh.factory<MovieDetailsBloc>(() => MovieDetailsBloc(get<IMovieRepository>()));
  gh.factory<MoviesListBloc>(() => MoviesListBloc(get<IMovieRepository>()));
